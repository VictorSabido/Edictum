...
(function ($) {
  ...
  *************************/
  ...
  var $window = $(window),
      ...
      $counter = $('.counter'),
      $datetp = $('.datetimepicker'); //Check if function exists
  ...
  POTENZA.leftbarsticky = function () {
    ...
    if ($leftfixed.exists()) {
      ...
      $window.on("scroll", function () {
        ...
        if (p != t) if (p = t, $(".mega-menu.desktopTopFixed").is(":visible")) {
