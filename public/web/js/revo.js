...
!function (jQuery, undefined) {
  ...
  jQuery.extend(!0, _R, {
    ...
    setSize: function setSize(e) {
      ...
      } : e.paddings, e.rowzones && e.rowzones.length > 0) for (var s = 0; s < e.rowzones[o].length; s++) {
  ...
  var _ISM = _R.is_mobile(),
    ...
    return t.kenburns = !1, t.parallax = !1, t.carousel = !1, t.navigation = !1, t.videos = !1, t.actions = !1, t.layeranim = !1, t.migration = !1, i.data("version") && i.data("version").toString().match(/5./gi) ? (i.find("img").each(function () {
      ...
      "object" == _typeof(t) && t.fileprefix != undefined && lAjax(t.fileprefix, e);
    }), t;
  },
    ...
    i.addons != undefined && i.addons.length > 0 && jQuery.each(i.addons, function (e, i) {
      "object" == _typeof(i) && i.init != undefined && _R[i.init] === undefined && (t = !1);
...
!function (a) {
  ...
  jQuery.extend(!0, b, {
    prepareCarousel: function prepareCarousel(a, d, h, i) {
    ...
    organiseCarousel: function organiseCarousel(a, b, c, d) {
      ...
      e.slides && jQuery.each(e.slides, function (d, h) {
        ...
        if ((c && Math.abs(l) < k || 0 === l) && (k = Math.abs(l), e.focused = d), j.width = e.slide_width, j.x = 0, j.transformPerspective = 1200, j.transformOrigin = "50% " + e.vertical_align, "on" === e.fadeout) {
          if ("on" === e.vary_fade) j.autoAlpha = 1 - Math.abs(1 / Math.ceil(e.maxVisibleItems / n) * l);else switch (e.horizontal_align) {
            case "center":
...
!function (a) {
  ...
  jQuery.extend(!0, b, {
    ...
    createFrameOnTimeline: function createFrameOnTimeline(a) {
      ...
      if (0 !== i || a.fromcurrentstate ? E = u(c.frames[i].mask) : D = u(c.frames[i].mask), A.anim.ease = void 0 === c.frames[i].ease ? punchgs.Power1.easeInOut : c.frames[i].ease, void 0 !== B && (B.anim.ease = void 0 === c.frames[i].ease ? punchgs.Power1.easeInOut : c.frames[i].ease, B.speed = void 0 === c.frames[i].speed ? B.speed : c.frames[i].speed, B.anim.x = B.anim.x * j.bw || s(B.anim.x, j, c.eow, c.eoh, c.calcy, c.calcx, "horizontal"), B.anim.y = B.anim.y * j.bw || s(B.anim.y, j, c.eow, c.eoh, c.calcy, c.calcx, "vertical")), void 0 !== A && (A.anim.ease = void 0 === c.frames[i].ease ? punchgs.Power1.easeInOut : c.frames[i].ease, A.speed = void 0 === c.frames[i].speed ? A.speed : c.frames[i].speed, A.anim.x = A.anim.x * j.bw || s(A.anim.x, j, c.eow, c.eoh, c.calcy, c.calcx, "horizontal"), A.anim.y = A.anim.y * j.bw || s(A.anim.y, j, c.eow, c.eoh, c.calcy, c.calcx, "vertical")), b.data("iframes") && e.add(punchgs.TweenLite.set(b.find("iframe"), {
        autoAlpha: 1
      }), d + "+=0.001"), i === c.outframeindex && (c.frames[i].to && c.frames[i].to.match(/auto:auto/g), A.speed = void 0 === c.frames[i].speed || "inherit" === c.frames[i].speed ? c.frames[c.inframeindex].speed : c.frames[i].speed, A.anim.ease = void 0 === c.frames[i].ease || "inherit" === c.frames[i].ease ? c.frames[c.inframeindex].ease : c.frames[i].ease, A.anim.overwrite = "auto"), 0 !== i || a.fromcurrentstate) 0 === i && a.fromcurrentstate && (A.speed = B.speed);else {
        if (n != b) {
      ...
      if (0 !== i || a.fromcurrentstate) {
        if ("block" === c._sfx_out && i === c.outframeindex) e.add(o.content.staggerTo(n, .001, {
          ...
          for (var M in n) {
            ...
            for (var P in L.to) {
              O[P] = parseInt(L.to[P].values[L.to[P].index], 0), L.to[P].index = L.to[P].index < L.to[P].len ? L.to[P].index + 1 : 0;
            }
    ...
    endMoveCaption: function endMoveCaption(a) {
      ...
      if (void 0 !== a.frame ? c.timeline.play(a.frame) : (!c["static"] || a.currentslide >= c.removeonslide || a.currentslide < c.showonslide) && (c.outnow = new punchgs.TimelineLite(), c.timeline.pause(), !0 === d.visibleelement && b.createFrameOnTimeline({
        ...
        opt: a.opt,
        fromcurrentstate: !0
      }).play()), a.checkchildrens && c.timeline_obj && c.timeline_obj.dchildren && "none" !== c.timeline_obj.dchildren && c.timeline_obj.dchildren.length > 0) for (var e = 0; e < c.timeline_obj.dchildren.length; e++) {
        b.endMoveCaption({
  ...
  var f = function f(a, c, d, e, _f, g, h, i, j) {
    var k = {};
    ...
    punchgs.TweenLite.set(d, {
      visibility: "visible"
    }), e.current_frame = a, e.current_timeline = _f, e.current_timeline_time = _f.time(), i && (e.static_layer_timeline_time = e.current_timeline_time), e.last_frame_started = a;
  },
      g = function g(a, b, c, d, e, f, _g, h, i, j) {
    "column" === d._nctype && C(i, j), punchgs.TweenLite.set(c, {
      visibility: "visible"
    }), d.current_frame = f, d.current_timeline = e, d.current_timeline_time = e.time(), h && (d.static_layer_timeline_time = d.current_timeline_time), void 0 !== d.hoveranim && !1 === d._gsTransformTo && (d._gsTransformTo = _g, d._gsTransformTo && d._gsTransformTo.startAt && delete d._gsTransformTo.startAt, void 0 === d.cssobj.styleProps.css ? d._gsTransformTo = jQuery.extend(!0, {}, d.cssobj.styleProps, d._gsTransformTo) : d._gsTransformTo = jQuery.extend(!0, {}, d.cssobj.styleProps.css, d._gsTransformTo)), d.visibleelement = !0;
  },
      h = function h(a, c, d, e, f, g, _h, i, j) {
    var k = {};
    k.layer = i, k.eventtype = 0 === a ? "enteredstage" : a === c - 1 || a === d ? "leftstage" : "frameended", k.layertype = i.data("layertype"), k.layersettings = i.data(), j.c.trigger("revolution.layeraction", [k]), "leftstage" !== k.eventtype && b.animcompleted(i, j), "leftstage" === k.eventtype && b.stopVideo && b.stopVideo(i, j), "column" === f._nctype && (punchgs.TweenLite.to(f._cbgc_man, .01, {
      ...
      visibility: "hidden",
      overwrite: "auto"
    }), f.animdirection = "out", f.visibleelement = !1, b.unToggleState(f.layertoggledby)), f.current_frame = a, f.current_timeline = g, f.current_timeline_time = g.time(), _h && (f.static_layer_timeline_time = f.current_timeline_time);
  },
      i = function i(a) {
    var b = {};
    ...
    var e = a[a.length - 1];
    if (a.length < b.rle) for (var f = 1; f <= b.curWinRange; f++) {
      a.push(e);
    }
    return a;
  },
...
!function (a) {
  ...
  var e = function e(a, b) {
    ...
    i = "swipebased" == e && "vertical" == k ? "none" : e ? "vertical" : i, jQuery.fn.swipetp || (jQuery.fn.swipetp = jQuery.fn.swipe), jQuery.fn.swipetp.defaults && jQuery.fn.swipetp.defaults.excludedElements || jQuery.fn.swipetp.defaults || (jQuery.fn.swipetp.defaults = new Object()), jQuery.fn.swipetp.defaults.excludedElements = "label, button, input, select, textarea, .noSwipe", h.swipetp({
      ...
      swipeStatus: function swipeStatus(e, g, h, i, l, m, n) {
...
!function (a) {
  ...
  var e = function e(a, b) {
    ...
    m > 2 && (q = o - (r + j) <= 0 ? o - (r + j) < 0 - j ? r : q + j : q, q = o - j + r + k < j && o + (Math.round(m) - 2) * j < r ? o + (Math.round(m) - 2) * j : q), q = q < 0 - (p - n) ? 0 - (p - n) : q > 0 ? 0 : q, "vertical" !== i && g.width() >= h.width() && (q = 0), "vertical" === i && g.height() >= h.height() && (q = 0), a.hasClass("dragged") || ("vertical" === i ? h.data("tmmove", punchgs.TweenLite.to(h, .5, {
      ...
      f = function f(a, b, c, d, e, _f3) {
    var g = c.parent().find(".tp-" + _f3 + "s"),
        h = g.find(".tp-" + _f3 + "s-inner-wrapper"),
        i = g.find(".tp-" + _f3 + "-mask"),
        j = d.width * a < d.min_width ? d.min_width : Math.round(d.width * a),
        k = Math.round(j / d.width * d.height),
        l = "vertical" === d.direction ? j : j * e + d.space * (e - 1),
        m = "vertical" === d.direction ? k * e + d.space * (e - 1) : k,
...
!function (a) {
  ...
  var d = function d(a, c, _d2, e) {
    ...
    return void 0 == b || jQuery.isNumeric(a) ? a : void 0 == a ? a : a.split(",")[b];
      ...
      g = function g(a, b, c, _g2, h, i, j, k) {
    ...
    var s = _g2.data("nexttransid") || 0,
        t = f(_g2.data("masterspeed"), s);
    t = "default" === t ? q[11] : "random" === t ? Math.round(1e3 * Math.random() + 300) : void 0 != t ? parseInt(t, 0) : q[11], t = t > l.delay ? l.delay : t, t += q[4], l.slots = f(_g2.data("slotamount"), s), l.slots = void 0 == l.slots || "default" == l.slots ? q[12] : "random" == l.slots ? Math.round(12 * Math.random() + 4) : l.slots, l.slots = l.slots < 1 ? "boxslide" == b ? Math.round(6 * Math.random() + 3) : "flyin" == b ? Math.round(4 * Math.random() + 1) : l.slots : l.slots, l.slots = (4 == a || 5 == a || 6 == a) && l.slots < 3 ? 3 : l.slots, l.slots = 0 != q[3] ? Math.min(l.slots, q[3]) : l.slots, l.slots = 9 == a ? l.width / l.slots : 10 == a ? l.height / l.slots : l.slots, l.rotate = f(_g2.data("rotate"), s), l.rotate = void 0 == l.rotate || "default" == l.rotate ? 0 : 999 == l.rotate || "random" == l.rotate ? Math.round(360 * Math.random()) : l.rotate, l.rotate = l.ie || l.ie9 ? 0 : l.rotate, 11 != a && (null != q[7] && d(j, l, q[7], q[5]), null != q[6] && d(i, l, q[6], q[5])), k.add(punchgs.TweenLite.set(i.find(".defaultvid"), {
      y: 0,
      x: 0,
      top: 0,
      left: 0,
    ...
    var u = f(_g2.data("easein"), s),
        v = f(_g2.data("easeout"), s);
    ...
    if (12 == a || 13 == a || 14 == a || 15 == a) {
      ...
      if (k.add(punchgs.TweenLite.set(h, {
        zIndex: 15
      }), 0), k.add(punchgs.TweenLite.set(_g2, {
        zIndex: 20
    ...
    if (16 == a) {
      ...
      k.add(punchgs.TweenLite.set(h.find(".tp-half-one"), {
        ...
        autoAlpha: 1
      }), 0), null != h.html() && k.add(punchgs.TweenLite.fromTo(_g2, (t - 200) / 1e3, {
        scale: va,
        x: l.width / 4 * ra,
        y: ba / 4 * sa,
        rotation: qa,
...
!function (e) {
  ...
  jQuery.extend(!0, a, {
    ...
    resetVideo: function resetVideo(e, o, d) {
      var r = e.data();
      ...
      switch (r.videotype) {
        ...
        case "html5":
          ...
          ("mute" == r.volume || a.lastToggleState(e.videomutetoggledby) || !0 === o.globalmute) && (u.muted = !0);
      }
    },
    ...
    playVideo: function playVideo(e, i) {
      ...
      switch (o.videotype) {
        case "youtube":
          if (0 == e.find("iframe").length) e.append(e.data("videomarkup")), n(e, i, !0);else if (void 0 != o.player.playVideo) {
        ...
        case "vimeo":
          if (0 == e.find("iframe").length) e.removeData("vimeoplayer"), e.append(e.data("videomarkup")), n(e, i, !0);else if (e.hasClass("rs-apiready")) {
            var l,
    ...
    prepareCoveredVideo: function prepareCoveredVideo(e, t, i) {
    ...
    manageVideoLayer: function manageVideoLayer(e, r, s, l) {
      if ("stop" === a.compare_version(o).check) return !1;
      var p = e.data(),
          v = p.videoattributes,
          c = p.ytid,
  ...
  var d = function d(e, t, a) {
    ...
    if (u.attr("id", c), d && e.data("startvideonow", !0), 1 !== e.data("videolistenerexist")) switch (n.videotype) {
          ...
          events: {
            onStateChange: function onStateChange(i) {
              ...
              if (i.data == YT.PlayerState.PLAYING) punchgs.TweenLite.to(e.find(".tp-videoposter"), .3, {
                ...
                display: "block",
                ease: punchgs.Power3.easeInOut
              }), "mute" == e.data("volume") || a.lastToggleState(e.data("videomutetoggledby")) || !0 === o.globalmute ? P.mute() : (P.unMute(), P.setVolume(parseInt(e.data("volume"), 0) || 75)), o.videoplaying = !0, p(e, o), m ? o.c.trigger("stoptimer") : o.videoplaying = !1, o.c.trigger("revolution.slide.onvideoplay", r(P, "youtube", e.data())), a.toggleState(n.videotoggledby);else {
                if (0 == i.data && g) {
                  var c = t(e.data("videostartat"));
                  -1 != c && P.seekTo(c), P.playVideo(), a.toggleState(n.videotoggledby);
                }
      ...
      case "vimeo":
        for (var f, h = u.attr("src"), b = {}, w = h, T = /([^&=]+)=([^&]*)/g; f = T.exec(w);) {
