...
CKEDITOR.addTemplates("default",
{
    ...
    [
        ...
        },
        {
            title:"Custom",
            image:"template3.gif",
            description:"qweweqwewqewqewqewqewe.",
            html:'<h3><img alt="" src=" " style="float:left; height:100px; margin-right:10px; width:100px" />Type the title here</h3><p>Type the text here</p>'
        }
    ]
});